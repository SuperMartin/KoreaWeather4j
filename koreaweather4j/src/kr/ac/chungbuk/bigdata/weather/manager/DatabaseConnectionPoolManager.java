...
public class DatabaseConnectionPoolManager {
	...
	public DatabaseConnectionPoolManager(boolean isMysq) {
	...
	public DatabaseConnectionPoolManager(boolean isMysq, String ipaddress, String port, String databaseName, String user, String passwd, String tableName) {
		this.isMysql = isMysql;
	 ...
	 * MySQL에 저장하는 메소드
	 */
	public void persistAWSWeatherData(List<KoreaWeatherAWSModel> list) {
		...
		try {
			...
			for (KoreaWeatherAWSModel mm : list) {
				String sql = "INSERT INTO " + TABLENAME + " VALUES (" + mm.getId() + ", '" + mm.getDate() + "', '" + mm.getPointName() + "', '" + mm.getLatitude() + "', '" + mm.getLongitude() + "', '" + mm.getAltitude() + "', '" + mm.getRain() + "', '" + mm.getRain15() + "', '" + mm.getRain60() + "', '" + mm.getRain6h() + "', '" + mm.getRain12h() + "', '" + mm.getRain24h() + "', '" + mm.getTemperature() + "', '" + mm.getWindDirection1() + "', '" + mm.getWindDirection1c() + "', '" + mm.getWindSpeed1() + "', '" + mm.getWindDirection10() + "', '" + mm.getWindDirection10c() + "', '" + mm.getWindSpeed10() + "', '" + mm.getHumidity() + "', '" + mm.getPressure() + "', '" + mm.getPointAddress() + "')";
				stmt.executeUpdate(sql);
				System.out.println("ID : " + mm.getId() + ", POINTNAME : " + mm.getPointName() + " ... Done.");
			}
